...
nn = NeuralNetwork([input_size] + hidden_layers + [output_size], dropout_rate=0.2, reg_lambda=0.01)
optimizer = AdamOptimizer(learning_rate=0.001)

nn.train(X_train, y_train, X_test, y_test, optimizer, epochs=100, batch_size=16, early_stopping_threshold=10)
